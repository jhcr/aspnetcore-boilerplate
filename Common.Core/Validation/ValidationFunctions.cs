...
namespace Common.Core.Validation
{
    ...
    public static class ValidationFunctions
    {
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public static bool ObjectRequired(object input, out string message)
        {
            message = string.Empty;
            if (input != null)
            {
        ...
        {
            var defaultErrorMessage = "must be a valid guid";
            ...
            else if (Guid.TryParse(input, out var guidValue) && guidValue != Guid.Empty)
            {
                value = guidValue;
                return true;
            }
        ...
        public static string _path(this string currentProperty, string parentProperty, string seperator = ".")
        {
